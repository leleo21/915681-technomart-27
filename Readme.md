...
* Студент: [Elena Kochneva](https://up.htmlacademy.ru/htmlcss/27/user/915681).
* Наставник: `Доминика`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/915681-technomart-27) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
